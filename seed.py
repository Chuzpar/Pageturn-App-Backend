...
BOOKS = [
    ...
    dict(title="Moby Dick", author="Herman Melville", price=14.50, genre="Classics",
         ...
         cover_url="https://covers.openlibrary.org/b/id/8101355-L.jpg"),
    ...
    dict(title="Frankenstein", author="Mary Shelley", price=10.99, genre="Gothic",
         ...
         cover_url="https://covers.openlibrary.org/b/id/11153218-L.jpg"),
    dict(title="The Trial", author="Franz Kafka", price=11.75, genre="Classics",
         rating=4.1, stock_for_lending=1,
         cover_url="https://covers.openlibrary.org/b/id/8235113-L.jpg"),
    dict(title="The Secret History", author="Donna Tartt", price=16.00, genre="Mystery",
         rating=4.6, stock_for_lending=2,
         cover_url="https://covers.openlibrary.org/b/id/14589209-L.jpg",
         description=(
...
def run():
    with app.app_context():
        ...
        member = User(full_name="Jane Kazungu", email="jane@pageturn.dev", role="member")
